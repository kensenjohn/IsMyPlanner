 ...
 */
public class ProcSaveChecklistTemplate extends HttpServlet {
        ...
        try{
            if( !DataSecurityChecker.isInsecureInputResponse(request) ) {
                ...
                if(loggedInUserBean!=null && !Utility.isNullOrEmpty(loggedInUserBean.getUserId()) ) {
                    ...
                    String sChecklistTemplateName = ParseUtil.checkNull( request.getParameter("checklist_template_name"));
                    String sChecklistTemplateId = ParseUtil.checkNull( request.getParameter("checklist_template_id"));

                    if(Utility.isNullOrEmpty(sChecklistTemplateName)) {
                        Text errorText = new ErrorText("Please enter a valid template name.","err_mssg") ;
                        ...
                        checklistTemplateRequestBean.setChecklistTemplateName(sChecklistTemplateName);
                        ...
                        ChecklistTemplateResponseBean checklistTemplateResponseBean = buildChecklistTemplate.saveChecklistTemplate( checklistTemplateRequestBean );
