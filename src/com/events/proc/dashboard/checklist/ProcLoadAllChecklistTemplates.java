 ...
 */
public class ProcLoadAllChecklistTemplates extends HttpServlet {
            ...
            if( !DataSecurityChecker.isInsecureInputResponse(request) ) {
                ...
                if(loggedInUserBean!=null && !Utility.isNullOrEmpty(loggedInUserBean.getUserId()) ) {
                    ...
                    if(checkPermission!=null && checkPermission.can(Perm.MANAGE_CHECKLIST_TEMPLATE_TAB)){
                        ...
                        Text errorText = new ErrorText("You are not authorized to manage checklist templates. Please contact your support representative.","err_mssg") ;
