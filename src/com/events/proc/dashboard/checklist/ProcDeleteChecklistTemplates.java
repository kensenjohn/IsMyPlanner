 ...
 */
public class ProcDeleteChecklistTemplates extends HttpServlet {
            ...
            if( !DataSecurityChecker.isInsecureInputResponse(request) ) {
                ...
                if(loggedInUserBean!=null && !Utility.isNullOrEmpty(loggedInUserBean.getUserId()) ) {
                    ...
                    if( Utility.isNullOrEmpty(sChecklistTemplateId)) {
                        ...
                        Integer iNumOfChecklistTemplateDeleted = buildChecklistTemplate.deleteChecklistTemplate( checklistTemplateRequestBean );
                        boolean isDeleted = false;
                        if(iNumOfChecklistTemplateDeleted>0){
                            isDeleted = true;
                        }
                        jsonResponseObj.put("is_deleted", isDeleted);
                        jsonResponseObj.put("deleted_checklist_template_id", sChecklistTemplateId);
