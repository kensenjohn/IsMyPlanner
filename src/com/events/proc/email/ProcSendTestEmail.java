...
import com.events.bean.common.email.TestEmailRequestBean;
import com.events.bean.users.UserBean;
import com.events.common.Constants;
import com.events.common.ParseUtil;
import com.events.common.Utility;
import com.events.common.email.creator.MailCreator;
import com.events.common.email.creator.TestEmailCreator;
import com.events.common.email.creator.TestEmailCreatorBaseService;
 ...
 */
public class ProcSendTestEmail extends HttpServlet {
        ...
        try{
            if( !DataSecurityChecker.isInsecureInputResponse(request) ) {
                ...
                if(loggedInUserBean!=null && !"".equalsIgnoreCase(loggedInUserBean.getUserId())) {
                    ...
                    if( !instance.isValidInput( "emailTest",sEmail,"Email",250,false ) ) {
                    ...
                    } else if (Utility.isNullOrEmpty(sEventEmailId) || Utility.isNullOrEmpty(sEventId)) {
                        ...
                        TestEmailRequestBean testEmailRequestBean = new TestEmailRequestBean();
                        testEmailRequestBean.setEventEmailId( sEventEmailId);
                        testEmailRequestBean.setEmail( sEmail);

                        MailCreator emailCreator = new TestEmailCreator();
                        TestEmailCreatorBaseService emailCreatorService = new TestEmailCreatorBaseService( emailCreator );
                        emailCreatorService.invokeTestEmailCreator(testEmailRequestBean);

                        Text okText = new OkText("The test email will be sent out in the next few minutes.","status_mssg") ;
