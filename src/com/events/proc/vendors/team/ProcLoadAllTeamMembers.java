 ...
 */
public class ProcLoadAllTeamMembers extends HttpServlet {
            ...
            if( !DataSecurityChecker.isInsecureInputResponse(request) ) {
                ...
                if(loggedInUserBean!=null && !Utility.isNullOrEmpty(loggedInUserBean.getUserId()) ) {
                    ...
                    if(vendorBean!=null && !Utility.isNullOrEmpty(vendorBean.getVendorId())) {
                        ...
                        Integer iNumOfJsonUserBean  = 0;
                        if(arrUserBean!=null && !arrUserBean.isEmpty()) {
                            ArrayList<UserInfoBean> arrUserInfoBeans =  accessUsers.getAllUsersInfo(arrUserBean);

                            JSONObject jsonObject = accessUsers.getJsonUserBeanAndInfo(arrUserBean , arrUserInfoBeans );
                            if(jsonObject!=null ){

                                iNumOfJsonUserBean = jsonObject.optInt("num_of_userbean");
                                if(iNumOfJsonUserBean>0) {
                                    jsonResponseObj.put("team_members" , jsonObject );
                                }
                            }
