...
import com.events.bean.vendors.*;
import com.events.common.*;
import com.events.common.exception.ExceptionHandler;
import com.events.common.security.DataSecurityChecker;
import com.events.json.*;
import com.events.vendors.AccessVendorLandingPage;
 ...
 */
public class ProcLoadVendorLandingPage extends HttpServlet {
            ...
            if( !DataSecurityChecker.isInsecureInputResponse(request) ) {
                ...
                if(loggedInUserBean!=null && !Utility.isNullOrEmpty(loggedInUserBean.getUserId()) ) {
                    ...
                    if(vendorBean!=null && !Utility.isNullOrEmpty(vendorBean.getVendorId())) {
                        ...
                        vendorLandingPageRequestBean.setVendorId( vendorBean.getVendorId() );

                        AccessVendorLandingPage accessVendorLandingPage = new AccessVendorLandingPage();
                        VendorLandingPageResponseBean vendorLandingPageResponseBean = accessVendorLandingPage.getVendorLandingPageByVendorId(vendorLandingPageRequestBean);
                        if(vendorLandingPageResponseBean!=null && vendorLandingPageResponseBean.getVendorLandingPageBean()!=null
                            ...
                            ArrayList<VendorLandingPageFeatureBean> arrVendorLandingPageFeatureBean = vendorLandingPageResponseBean.getArrVendorLandingPageFeatureBean();
                            if(arrVendorLandingPageFeatureBean!=null && !arrVendorLandingPageFeatureBean.isEmpty()) {
                                for(VendorLandingPageFeatureBean vendorLandingPageFeatureBean : arrVendorLandingPageFeatureBean ) {
                                    jsonResponseObj.put( vendorLandingPageFeatureBean.getFeatureName() , vendorLandingPageFeatureBean.getValue() );
                                }
                            }
                        }
                        ...
                        Text errorText = new ErrorText("Oops!! We were unable to process your request at this time. Please try again later.(loadVendorLandingPage - 003)","err_mssg") ;
