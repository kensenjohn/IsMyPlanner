 ...
 */
public class ProcDeleteEventChecklistTodo extends HttpServlet {
            ...
            if( !DataSecurityChecker.isInsecureInputResponse(request) ) {
                ...
                if(loggedInUserBean!=null && !Utility.isNullOrEmpty(loggedInUserBean.getUserId()) ) {
                    ...
                    if( Utility.isNullOrEmpty(sEventChecklistTodoId)) {
                        ...
                        Integer numOfRowsDeleted = buildEventChecklist.deleteEventChecklistTodo( eventChecklistRequestBean ) ;
                        ...
                        jsonResponseObj.put("is_deleted", isDeletedSuccess );
                        jsonResponseObj.put("deleted_event_checklist_todo_id", sEventChecklistTodoId );
