 ...
 */
public class ProcUpdateEventChecklistItemAction extends HttpServlet {
        ...
        try{
            if( !DataSecurityChecker.isInsecureInputResponse(request) ) {
                ...
                if(loggedInUserBean!=null && !Utility.isNullOrEmpty(loggedInUserBean.getUserId()) ) {
                    ...
                    String sEventChecklistAction = ParseUtil.checkNull(request.getParameter("item_action"));
                    boolean isItemComplete = false;
                    if( "active".equalsIgnoreCase(sEventChecklistAction) ) {
                        isItemComplete = false;
                    } else if( "done".equalsIgnoreCase(sEventChecklistAction) ) {
                        isItemComplete = true;
                    }

                    if( Utility.isNullOrEmpty(sEventChecklistItemId)) {
                        Text errorText = new ErrorText("Please select a valid Checklist Item","err_mssg") ;
                        ...
                        Integer numOfRowsUpdated = buildEventChecklist.updateEventChecklistItemAction( eventChecklistRequestBean );
                        ...
                        jsonResponseObj.put("current_action" , sEventChecklistAction );
