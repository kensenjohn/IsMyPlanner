 ...
 */
public class ProcLoadEvent  extends HttpServlet {
            ...
            if( !DataSecurityChecker.isInsecureInputResponse(request) ) {
                ...
                if(loggedInUserBean!=null && !"".equalsIgnoreCase(loggedInUserBean.getUserId())) {
                    ...
                    if(sEventId!=null && !"".equalsIgnoreCase(sEventId)){
                        ...
                        if(eventResponseBean!=null && eventResponseBean.getEventBean()!=null && !"".equalsIgnoreCase(eventResponseBean.getEventBean().getEventId())) {
                            ...
                            appLogging.info("Load event failed for  sEventId : " + sEventId );
                            Text errorText = new ErrorText("Oops!! We were unable to process your request at this time. Please try again later.(loadEvent - 003)","err_mssg") ;
                        ...
                        appLogging.info("Missing required parameters  sEventId : " + sEventId );
                        Text errorText = new ErrorText("Oops!! We were unable to load information about the event.","err_mssg") ;
                        arrErrorText.add(errorText);
                        responseStatus = RespConstants.Status.ERROR;
                    }
