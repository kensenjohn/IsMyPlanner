 ...
 */
public class ProcLoadPotentialEventAndPartnerVendor extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            if( !DataSecurityChecker.isInsecureInputResponse(request) ) {
                ...
                if(loggedInUserBean!=null && !Utility.isNullOrEmpty(loggedInUserBean.getUserId()) ) {
                    ...
                    if( vendorBean!=null && !Utility.isNullOrEmpty(vendorBean.getVendorId())  ) {
                        ...
                        Text errorText = new ErrorText("Oops!! We were unable to process your request at this time. Please try again later,.(lAEPVendors - 003)","err_mssg") ;
                    ...
                    Text errorText = new ErrorText("Oops!! We were unable to process your request at this time. Please try again later.(lAEPVendors - 002)","err_mssg") ;
                    arrErrorText.add(errorText);
            ...
            Text errorText = new ErrorText("Oops!! We were unable to process your request at this time. Please try again later.(lAEPVendors - 001)","err_mssg") ;
            arrErrorText.add(errorText);
