 ...
 */
public class ProcLoadEventBudgetCategory extends HttpServlet {
        ...
        try{
            if( !DataSecurityChecker.isInsecureInputResponse(request) ) {
                ...
                if(loggedInUserBean!=null && !Utility.isNullOrEmpty(loggedInUserBean.getUserId()) ) {
                    ...
                    EventBudgetCategoryBean eventBudgetCategoryBean = accessEventBudget.getBudgetCategoryByCategory( eventBudgetRequestBean );
                    if(eventBudgetCategoryBean!=null && !Utility.isNullOrEmpty(eventBudgetCategoryBean.getBudgetCategoryId()) ){
                        ...
                        if(arrEventBudgetCategoryItemBean!=null && !arrEventBudgetCategoryItemBean.isEmpty() ){
                            ...
                            if(lNumOfItems>0){
                                jsonResponseObj.put("budget_items",jsonItems);
                            }
                        }
                        ...
                        Text errorText = new ErrorText("We were unable to process your request at this time. Please select a valid category.(loadEventBudgetCategory - 002)","err_mssg") ;
                    ...
                    Text errorText = new ErrorText("Oops!! We were unable to process your request at this time. Please try again later.(loadEventBudgetCategory - 002)","err_mssg") ;
                    arrErrorText.add(errorText);
            ...
            Text errorText = new ErrorText("Oops!! We were unable to process your request at this time. Please try again later.(loadEventBudgetCategory - 001)","err_mssg") ;
            arrErrorText.add(errorText);
