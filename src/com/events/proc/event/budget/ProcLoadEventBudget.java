 ...
 */
public class ProcLoadEventBudget extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            if( !DataSecurityChecker.isInsecureInputResponse(request) ) {
                ...
                if(loggedInUserBean!=null && !Utility.isNullOrEmpty(loggedInUserBean.getUserId()) ) {
                    ...
                    if(Utility.isNullOrEmpty(sEventId)){
                        ...
                        EventBudgetResponseBean eventBudgetResponseBean = accessEventBudget.loadEventBudget( eventBudgetRequestBean );
                        ...
                        if( eventBudgetResponseBean!=null ) {
                            ...
                            Text errorText = new ErrorText("Oops!! We were unable to process your request at this time. Please try again later.(loadEventBudget - 003)","err_mssg") ;
                            arrErrorText.add(errorText);
                    ...
                    Text errorText = new ErrorText("Oops!! We were unable to process your request at this time. Please try again later.(loadEventBudget - 002)","err_mssg") ;
                    arrErrorText.add(errorText);
            ...
            Text errorText = new ErrorText("Oops!! We were unable to process your request at this time. Please try again later.(loadEventBudget - 001)","err_mssg") ;
            arrErrorText.add(errorText);
