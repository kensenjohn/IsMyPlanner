 ...
 */
public class ProcLoadTodosReminderSchedule extends HttpServlet {
        ...
        try{
            if( !DataSecurityChecker.isInsecureInputResponse(request) ) {
                ...
                if(loggedInUserBean!=null && !Utility.isNullOrEmpty(loggedInUserBean.getUserId()) ) {
                    ...
                    TodoReminderScheduleBean todoReminderScheduleBean =accessToDo.getTodoReminderScheduleByTodoId( toDoRequestBean );
                    ...
                    Text errorText = new ErrorText("Oops!! We were unable to process your request at this time. Please try again later.(loadTodoReminder - 002)","err_mssg") ;
            ...
            Text errorText = new ErrorText("Oops!! We were unable to process your request at this time. Please try again later.(loadTodoReminder - 001)","err_mssg") ;
            arrErrorText.add(errorText);
