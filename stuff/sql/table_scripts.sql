...
create TABLE GTPERMISSION ( PERMISSIONID VARCHAR(45) NOT NULL, PERMISSIONDESCRIPTION VARCHAR(1000) NOT NULL, CATEGORY VARCHAR(1000) NOT NULL, PRIMARY KEY (PERMISSIONID) ) ENGINE = MyISAM DEFAULT CHARSET = utf8;
create table GTUSERPERMISSION ( USERPERMISSIONID VARCHAR(45) NOT NULL, FK_USERID VARCHAR(45) NOT NULL, FK_PERMISSIONID VARCHAR(45) NOT NULL, PRIMARY KEY (USERPERMISSIONID) ) ENGINE = MyISAM DEFAULT CHARSET = utf8;
...
CREATE TABLE GTUSERROLES
(
  USERROLEID VARCHAR(45) PRIMARY KEY NOT NULL,
  FK_ROLEID VARCHAR(45) NOT NULL,
  FK_USERID VARCHAR(45) NOT NULL
);
CREATE TABLE GTROLEPERMISSIONS
(
  ROLEPERMISSIONID VARCHAR(45) PRIMARY KEY NOT NULL,
  FK_ROLEID VARCHAR(45) NOT NULL,
  FK_PERMISSIONID VARCHAR(45) NOT NULL
);
CREATE TABLE GTROLES
(
  ROLEID VARCHAR(45) PRIMARY KEY NOT NULL,
  FK_PARENTID VARCHAR(45) NOT NULL,
  NAME VARCHAR(45) NOT NULL,
  CREATEDATE BIGINT DEFAULT 0 NOT NULL,
  HUMANCREATEDATE VARCHAR(45),
  IS_SITEADMIN INT DEFAULT 0 NOT NULL
);
CREATE TABLE GTPERMISSIONGROUP
(
  PERMISSIONGROUPID VARCHAR(45) PRIMARY KEY NOT NULL,
  GROUP_NAME VARCHAR(100) NOT NULL,
  FK_PARENTID VARCHAR(45) NOT NULL
);
CREATE TABLE GTPERMISSIONS
(
  PERMISSIONID VARCHAR(45) PRIMARY KEY NOT NULL,
  PERMISSIONGROUPID VARCHAR(45) NOT NULL,
...
CREATE TABLE GTROLES (ROLEID VARCHAR(45) NOT NULL, FK_PARENTID VARCHAR(45) NOT NULL, NAME VARCHAR(45) NOT NULL, CREATEDATE BIGINT(20) NOT NULL DEFAULT 0, HUMANCREATEDATE VARCHAR(45), IS_SITEADMIN INT(1) NOT NULL DEFAULT 0 ,  PRIMARY KEY (ROLEID) ) ENGINE = MyISAM DEFAULT CHARSET = utf8;