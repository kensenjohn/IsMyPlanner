...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/windsor_style.css">
    <link rel="stylesheet" type="text/css" href="css/windsor_font_Amatic.css">
        ...
        <header id="header">
            <nav class="navbar navbar-default" role="navigation">
                <div class="container-fluid">
                    ...
                    <!-- Collect the nav links, forpms, and other content for toggling -->
                        ...
                        <ul class="nav navbar-nav  navbar-right">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="#about_the_couple">The Couple</a></li>
                                    <li><a href="#bridesmaid">Bride's Maids</a></li>
                                    <li><a href="#groomsmen">Groom's Men</a></li>
                                </ul>
                            </li>
                            <li class="dropdown">
...
<div class="invitation-block"  style="background-color: #FFFFFF	">
    ...
    <div class="row">
        <div class="col-md-12">
            <div style="text-align: center"><p>cordially invite you to their wedding on</p></div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <h2><div style="text-align: center">May 26, 2008</div></h2>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
    ...
    <div class="row">
        <div class="col-md-12">
            <h2><div style="text-align: center">Heinz Field</div></h2>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div style="text-align: center"><p>100 Art Rooney Ave, Pittsburgh, PA 15212</p></div>
        </div>
    </div>
</div>
<div class="row">
...
<script   type="text/javascript">
    $(window).load(function() {
        $.backstretch("/cl/Windsor/img/red_white_shoes.jpg");
        ...
        $('#googlemaps_ceremony').gMap({
            ...
            markers: [
                {
                    address: '100 Art Rooney Ave, Pittsburgh, PA 15212', // Your Adress Here
                    html: '',
                    popup: false
                }
            ]
        ...
        $('#googlemaps_reception').gMap({
            ...
            markers: [
                {
                    address: '21 W 52nd St,  New York, NY, 10019', // Your Adress Here
                    html: '',
                    popup: false
                }
            ]
