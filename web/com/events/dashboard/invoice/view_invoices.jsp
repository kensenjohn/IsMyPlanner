...
<%
    ...
    String breadCrumbPageTitle = "Invoice - View";
    boolean loadInvoice = true;
%>
<body>
<div class="page_wrap">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="client_selector" name="invoiceClient"/>
                        </div>
                        <div class="col-md-4">
...
$(window).load(function() {
    ...
    //loadSingleClient(populateClient);
...
function loadSingleClient(callbackmethod) {
    var actionUrl = "/proc_load_clients.aeve";
    var methodType = "POST";
    var dataString = '';
    makeAjaxCall(actionUrl,dataString,methodType,callbackmethod);
}
function populateClient(jsonResult) {
    if(jsonResult!=undefined) {
        var varResponseObj = jsonResult.response;
        if(jsonResult.status == 'error'  && varResponseObj !=undefined ) {
            displayAjaxError(varResponseObj);
